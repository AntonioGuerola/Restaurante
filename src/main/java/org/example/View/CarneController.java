...
public class CarneController extends Controller implements Initializable {
    @FXML
    private VBox vbox;

    private final ProductoDAO carneDAO;

    public CarneController() {
        this.carneDAO = new ProductoDAO();
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        List<Producto> productos = carneDAO.findAllCarne();
