...
public class PostreController extends Controller implements Initializable {
    @FXML
    private VBox vbox;

    private final ProductoDAO postreDAO;

    public PostreController() {
        this.postreDAO = new ProductoDAO();
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        List<Producto> productos = postreDAO.findAllPostre();
