...
public class VinoController extends Controller implements Initializable {
    @FXML
    private VBox vbox;

    private final ProductoDAO vinoDAO;

    public VinoController() {
        this.vinoDAO = new ProductoDAO();
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        List<Producto> productos = vinoDAO.findAllVino();
